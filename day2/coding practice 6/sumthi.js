...
let outerCont = document.getElementById('profileContainer');
outerCont.classList.add("d-flex", "flex-column", "text-center", "justify-content-center");
let imageContainerEl = document.getElementById('imgContainer');
let imageCont = document.createElement('img');
imageCont.src = profileDetails.imgSrc;
imageCont.classList.add('image-class');
imageContainerEl.appendChild(imageCont);


let headingCont = document.createElement('h1');
headingCont.textContent = profileDetails.name;
headingCont.classList.add('heading-class');
outerCont.appendChild(headingCont);

let ageCont = document.createElement('p');
ageCont.textContent = "Age : " + profileDetails.age;
ageCont.classList.add('age-class');
outerCont.appendChild(ageCont);
